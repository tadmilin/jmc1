                ...
                {categories.map((category) => (
                  <li key={category.id}>
                    <button
                      ...
                      className="flex items-center p-3 rounded-lg hover:bg-blue-50 transition-all duration-200 group border border-transparent hover:border-blue-200 w-full text-left"
                    >
                      {/* รูปภาพหมวดหมู่ */}
                      <div className="flex-shrink-0 mr-3">{renderCategoryImage(category)}</div>
