...
const getFilename = (field: string | Media): string => {
        ...
        <div className={containerClass}>
          {catalogs?.map((catalog) => (
            ...
            >
              ...
              >
                <Image
                  src={`${process.env.NEXT_PUBLIC_SERVER_URL}/media/${getFilename(catalog.thumbnailImage)}`}
                  alt={catalog.name}
                  fill
              ...
              >
                ...
                <a
                  href={`${process.env.NEXT_PUBLIC_SERVER_URL}/media/${getFilename(catalog.pdfFile)}`}
                  target="_blank"
