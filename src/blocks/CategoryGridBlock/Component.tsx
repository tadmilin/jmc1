  ...
  useEffect(() => {
    const fetchCategories = async () => {
      ...
      try {
        ...
        if (blockConfig.categorySelection === 'select' && Array.isArray(blockConfig.categories) && blockConfig.categories.length > 0) {
              ...
              return (
                ...
                >
                  ...
                  {blockConfig.showCategoryNames && (
                    <div className="p-3">
                      <h3 className="text-sm md:text-base font-medium text-gray-900 group-hover:text-blue-600 transition-colors text-center line-clamp-2">
