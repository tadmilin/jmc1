...
export default function ProductDetailClient({ product }: ProductDetailClientProps) {
  ...
  const discountPercent = isCurrentOnSale
  ...
  const handleShare = async () => {
    if (navigator.share) {
      try {
        const shareText =
          shortDescription || (typeof description === 'string' ? description : title)
                    ...
                    {variants.map((variant, index) => (
                      ...
                      >
                        ...
                        <div className="text-sm">
                          ...
                          variant.variantSalePrice < variant.variantPrice ? (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    ...
                    {product.addLineButton?.enabled && (
                      <Button
                        ...
                        onClick={() =>
                          window.open(
                            product.addLineButton?.lineUrl ||
                              PRODUCT_BUTTON_CONFIG.defaults.lineUrl,
                            '_blank',
                          )
                        }
                      >
