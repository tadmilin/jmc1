...
export type ProductCardData = Pick<Product, 'id' | 'title' | 'slug' | 'price' | 'salePrice' | 'shortDescription' | 'images' | 'categories' | 'stock' | 'status'>
...
export const ProductCard: React.FC<{
  ...
  const { title, slug, price, salePrice, shortDescription, images, categories, stock, status } = product
  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        {/* Title */}
        <h3 className={`text-lg font-bold leading-tight mb-2 transition-colors duration-300 ${
          isDarkTheme 
